...
def main():
    ...
    modelo_G_A2B = 'https://raw.githubusercontent.com/daang04/ACIS-grupo3/main/Avances/Presentacion%20Parcial/Modelos_entrenados/generador_A_entrenado.pth'  # Cambia esta ruta
